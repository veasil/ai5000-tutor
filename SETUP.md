...
- 第 3 关实感力启动最小页面与推进端点
- 第 4 关问题侦探局最小页面与推进端点
- 第 5 关 AI机制拆解局最小页面与推进端点
- 第 6 关 AI共创准备站最小页面与推进端点
- 第 7 关愿景与方法站最小页面与推进端点
- 第 8 关 Demo工坊最小页面与推进端点
- 第 9 关影响力最小页面、责任自检报告与推进端点
- 第 10 关发布会最小页面、作品卡生成、徽章发放与发布完成端点
- 首页与第 2-10 关前端完整嵌入原始静态 HTML 原型，React/Next 只做无感按钮桥接、状态机入口与数据入库
- 最小 AI Tutor JSON 接口
